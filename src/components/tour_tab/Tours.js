    ...
    return(
        <Container className="tours">
            ...
            <ul className='tab_list'>
                <li className='item'>
                    <button onClick={() => handleCityClick("New York")}>New York</button>
                </li>
                <li className='item'>
                    <button onClick={() => handleCityClick("London")}>London</button>
                </li>
                <li className='item'>
                    <button onClick={() => handleCityClick("Tokyo")}>Tokyo</button>
                </li>
                <li className='item'>
                    <button onClick={() => handleCityClick("Los Angeles")}>Los Angeles</button>
                </li>
            </ul>
            <div>
                <Row>
